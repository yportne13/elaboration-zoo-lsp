...
//! `rename_iter`/prune_*/`lams_from_ty`，全迭代）。原 bump_spine_iter.rs 的
//! "solve" 节，逐行搬运（2026-09-23 拆分）。
...
use super::env::{EMPTY_ENV, PiCell, env_ext};
use super::eval::{W, eval_iter};
use super::force::{force, force_arg};
use super::machine::neutral_of;
use super::spine::{MetaEntry, Spine};
use super::syntax::{GLOBAL_BASE, PrCons, SumDataT, SumParamT, Tm, V, XCell, v_clo_of, v_lvl, v_lvl_of, v_meta_of, v_pi_of, v_spine_of, v_tag, v_u_of, v_xcell_of};
