//! bench_src：基准负载生成器（L09 语法子集：`Type N` 宇宙、string_concat、
//! enum/match、递归 def、struct/new）。bins（l09bench/l06l13mem）与
//! tests/l09_fast_parity 经入口再导出引用。逐行搬运（2026-09-23 拆分）。
