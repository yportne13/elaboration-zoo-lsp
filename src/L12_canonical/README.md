...
`match` 上孪生反而比参考版慢，首测 0.3×）。实测（同窗口交错 A/B 的**比值**，
两窗口一致）：
...
移植后绝对数（`docs/bench-matrix-2026-09-18.md`，k=11）：参考版 basic 0.218 ms、
孪生 fast_ss 0.176 ms、fast_run 0.222 ms；孪生/参考由 0.3×（落后）变为
**0.98–1.24×（持平到略优）**。
