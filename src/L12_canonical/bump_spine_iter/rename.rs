//! rename：solve 族（`RenBuf`/invert_bump/solve_with_pren_bump/solve_bump/
//! rename_iter/prune_vflex_bump/prune_meta_bump/prune_ty_bump/lams_from_ty/
//! alloc_xname，全迭代）。原 bump_spine_iter.rs 的 "solve" 节，逐行搬运
//! （2026-09-23 拆分）。
...
use super::spine::{MetaEntry, MetaSnap, Spine};
use super::syntax::{
