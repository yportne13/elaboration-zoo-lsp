...
impl PatternDetail {
    ...
    fn bind_names(&self, ns: &List<SmolStr>) -> List<SmolStr> {
        match self {
            PatternDetail::Any(..) => ns.prepend(SmolStr::new("_")),
...
mod prelude_tests {
    ...
    const PRELUDE_FILES: &[(&str, &str)] = &[
        ...
        ("natarith.typort", include_str!("../prelude/core/natarith.typort")),
