...
use super::syntax::{
    pending_to_vec, SumDataT, SumDataV, SumParamT, SumParamV, Tm, V, XCell, v_clo_of,
    v_lvl, v_lvl_of, v_meta_of, v_pi_of, v_spine_of, v_tag, v_xcell_of,
};
                ...
                match v_tag(v) {
                    ...
                    7 => match v_xcell_of(v) {
                        ...
                        XCell::Match {
                            ...
                            // 卡住期累积的实参按应用序包在 Match 外的 App 链里
                            //（cons 链经 pending_to_vec 恢复序后逐个引）
