...
macro_rules! T {
    [def] => { $crate::L07_head::parser::TokenKind::DefKeyword };
    [let] => { $crate::L07_head::parser::TokenKind::LetKeyword };
    [U] => { $crate::L07_head::parser::TokenKind::UKeyword };
    [_] => { $crate::L07_head::parser::TokenKind::Hole };
    ['('] => { $crate::L07_head::parser::TokenKind::LParen };
    [')'] => { $crate::L07_head::parser::TokenKind::RParen };
    ['['] => { $crate::L07_head::parser::TokenKind::LSquare };
    [']'] => { $crate::L07_head::parser::TokenKind::RSquare };
    ['{'] => { $crate::L07_head::parser::TokenKind::LCurly };
    ['}'] => { $crate::L07_head::parser::TokenKind::RCurly };
    [.] => { $crate::L07_head::parser::TokenKind::Dot };
    [,] => { $crate::L07_head::parser::TokenKind::Comma };
    [=] => { $crate::L07_head::parser::TokenKind::Eq };
    [;] => { $crate::L07_head::parser::TokenKind::Semi };
    [:] => { $crate::L07_head::parser::TokenKind::Colon };
    [->] => { $crate::L07_head::parser::TokenKind::Arrow };
    [=>] => { $crate::L07_head::parser::TokenKind::DoubleArrow };
    ['\\'] => { $crate::L07_head::parser::TokenKind::Lambda };
    [:=] => { $crate::L07_head::parser::TokenKind::AssignEq };
}
