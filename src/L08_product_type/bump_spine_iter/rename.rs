...
//! 原 bump_spine_iter.rs 的 "solve" 节，逐行搬运（2026-09-23 拆分）。
...
use super::env::{EMPTY_ENV, env_ext, PiCell};
...
use super::syntax::{PrCons, SumDataT, SumParamT, Tm, V, v_clo_of, v_lvl, v_lvl_of, v_meta_of, v_pi_of, v_spine_of, v_tag, v_xcell_of, XCell};
